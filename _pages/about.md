...
------
<details>
<summary><a href="https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4764605">Tax Planning, Illiquidity, and Credit Risks: Evidence from DeFi Lending</a> (with Lisa De Simone, Daniel Rabetti)</summary>

**Abstract:**  
This study examines the link between tax-planning-induced illiquidity and credit risks in lending markets. Exploiting an exogenous tax shock on cryptocurrency gains and millions of transactions in Decentralized Finance (DeFi) lending, we document that tax-motivated borrowing strategies to defer capital gains taxes significantly reduce market liquidity. This effect is pronounced among individuals borrowing in stablecoins (to monetize returns), those with higher loan-to-value ratios (more risk-averse to new regulations and typically with larger taxable gains), those with high returns in the underlying asset, and those holding locked-in assets for over a year (i.e., converting high short-term to lower long-term capital gains tax rates). Using instrumental variable analysis, we show a plausibly causal link between tax-planning-induced illiquidity and increased credit risks: a one standard deviation increase in tax-induced illiquidity more than doubles the value of defaulted loans. The results are robust to a battery of checks, including subsample analyses of highly tax-sensitive borrowers, and align with well-documented tax awareness periods. Overall, our findings inform market participants, help estimate tax revenue losses, and support emerging policies on the taxation of digital assets.
